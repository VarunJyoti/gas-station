...
<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>
						...
						<a href="<?php echo base_url();?>admin/page/">End User Management</a>
		...
		<!-- Widget -->
				...
				<div class="form-actions">
					...
					<div class="col-md-offset-3 col-md-9">
						...
						<button type="button" class="btn btn-icon btn-default glyphicons circle_remove" onClick="window.location='<?php echo base_url('admin/enduser/');?>';"><i></i>Cancel</button>
					</div>
					</div>
				</div>	
