...
<div style="float:right;">
     <form class="navbar-form"  action="<?php echo base_url('admin/company/records');?>" method="GET">
  <tr>
   ...
   <td> 
    ...
    <td> 
     ...
     {
	  ?>  
	  <option value='<?php echo $no->daily_shift_id;?>'><?php echo $no->daily_shift_id;?></option>
	 <?php   
    }
    ?>
    </select>
...
<tr>
    ...
    $rcount= count($Gasoline_Record);
    $rcount1= count($Gasoline_Record)+1;
	foreach($Gasoline_Record as $row)
	{
