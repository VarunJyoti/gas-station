...
<div class="innerLR">
	...
	<form class="form-horizontal margin-none" enctype="multipart/form-data" action="<?php echo base_url('admin/suburbs/save');?>" name="basic_validate" id="add_banner" novalidate="novalidate" method="post">
		...
		<input type="hidden" name="id" id="id" value="<?php echo $suburbs->id;?>"/>
			<!-- Widget heading -->
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="name" value="<?php echo $suburbs->name;?>" name="name" type="text" /><?php echo form_error('name'); ?></div>
						</div>
						<!-- // Group END -->
						...
						<div class="control-group">
							...
							<?php echo $this->City_model->cityDrop($suburbs->city_id);?>
							</select>
						...
						<div class="control-group">
							...
							<div class="controls">
								<label><input type="radio" name="status" id="statu" value="1" <?php if($suburbs->status == 1)echo 'checked="checked"';?>/>
									Active </label>
									<label><input type="radio" name="status" value="0" id="statuss" <?php if($suburbs->status == 0)echo 'checked="checked"';?>/>
										Disable </label>
							</div>
						</div>
				...
				<!-- // Row END -->	
					...
					<div class="row-fluid uniformjs">	
						...
						<div class="form-actions">
							<button type="submit" name='edit_suburbs' value='Save' class="btn btn-icon btn-primary glyphicons circle_ok"><i></i>Save</button>
