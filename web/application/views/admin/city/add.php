				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="city_code" value="<?php echo set_value('city_code');?>" name="city_code" type="text" /><?php echo form_error('city_code'); ?></div>
						</div>
						<!-- // Group END -->
						<div class="control-group">
							...
							<?php echo $this->State_model->statedrop();?>
							</select>
						...
						<div class="control-group">
							...
							<div class="controls"><input class="span12" id="title" value="<?php echo set_value('title');?>" name="title" type="text" /><?php echo form_error('title'); ?></div>
						</div>
						<!-- // Group END -->
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="meta_title">Meta Title</label>
							<div class="controls"><input class="span12" id="meta_title" name="meta_title" type="text" value='<?php echo set_value('meta_title');?>'/><?php echo form_error('meta_title'); ?></div>
						</div>
						<!-- // Group END -->
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="meta_keyword">Meta Keyword</label>
							<div class="controls"> <textarea id="meta_keyword" name="meta_keyword"><?php echo set_value('meta_keyword');?></textarea><?php echo form_error('meta_keyword'); ?></div>
						</div>
						<!-- // Group END -->
						<!-- Group -->
						<div class="control-group">
							<label class="control-label" for="meta_description">Meta Description</label>
							<div class="controls"> <textarea id="meta_description" name="meta_description"><?php echo set_value('meta_description');?></textarea><?php echo form_error('meta_description'); ?></div>
						</div>
						<!-- // Group END -->
						<!-- Group -->
						<!--div class="control-group">
