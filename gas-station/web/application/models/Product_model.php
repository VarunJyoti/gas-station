...
class Product_model extends CI_Model{
	...
	protected static $db_fields = array('id', 'p_name',	'p_cat', 'p_image', 'p_desc', 'p_price', 'date_created', 'date_modified', 'status', 'c_id', 'merged');
	...
	// get product price by ID Latest
	public function getProductPriceByIDLastDate($id) 
	{	
		$this->db->where("pid",$id);
		$c_id = $this->company_model->getCompanyLoginId();
		$this->db->where("c_id",$c_id);
