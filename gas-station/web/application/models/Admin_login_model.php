...
class Admin_login_model extends CI_Model {
                ...
                if($daily_no_status == 'close')
		         {
				  ...
				  $this->db->insert($table,$data);
				   ...
				   //insert code Price table
				            $pid=$this->getProductID($c_id);
				           ...
				           // print_r($pid); die('err');
							 foreach($pid as $piid)
					  {     
					     // print_r($piid->pid); die('err');
					     $product_id = $piid->id;
						 $price_id=$this->getProductPriceByIDLastDate($piid->pid,$c_id)->id;
						 $price=$this->getProductPriceByIDLastDate($piid->pid,$c_id)->s_price;
						 $old_price= $this->getProductPriceByIDLastDate($piid->pid,$c_id)->old_price;
						 $data_price = array('id'=> NULL, 'pid'=> $product_id, 'price'=> $price, 's_price'=> $price, 'old_price'=> $old_price, 'c_id'=> $c_id, 'date_created'=> $date_created, 'date_modified'=> '');
						 $this->db->insert($table_price,$data_price);
					  }
                     //insert code Price table ends 
 ...
 public function CheckEnduser() 
	...
	public function getProductID($cid) 
	    {
		 ...
		 public function getProductPriceByIDLastDate($id,$c_id) 
	{	
