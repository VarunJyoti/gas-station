...
// insert code for users table ends here
 ...
 // Function for  IP address starts here		
	...
	public function deleteCcardEntry($id)
	{
		$result = $this->db->delete('ccard_entry', array('id' => $id)); 
		return $result;
	...
	{
		$result = $this->db->delete('creditamount_entry', array('id' => $id)); 
		return $result;
	...
	{  
		 ...
		 $query = $this->db->get('admins')->row_array();
		 $query1=$this->db->last_query($query);
	  // print_r($query1); die('err');
