...
<!-- page content -->
	...
	<?php } ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Main Category<small></small></h2>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
		  <input type="text"   required="required" class="form-control" id="cat_name" name="cat_name" value="" placeholder="Category Name">
	...
	<table class="footable table table-striped table-bordered table-white table-primary">
		...
		<thead>
			<tr>
				<th>Sr.No</th>
				<th data-class="Title">Category Name</th>
			 ...
			 <?php
				...
				if(!empty($MainCat)){
					...
					foreach($MainCat as $pro)
					{
						...
						<td class="center"><a class='btn btn-primary btn-mini' href='<?php echo  base_url("admin/company/edit_expcat/{$pro->id}");?>'><i class='icon-edit icon-white'></i> Edit </a>
...
$(document).ready(function(){  
	...
	function page_delete(id){
			...
			if (r == true) {
			location.href = '<?php echo base_url("admin/company/DeleteExpCat");?>/'+id;
			} else {
				return false;
			}
