...
<!-- page content -->
	...
	<?php } ?>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
		  <input type="text" readonly  required="required" class="form-control" id="name" name="name" value="<?php echo $page->user_id;?>" placeholder="Name">
		  ...
		  <option value="<?php echo $page->cc_type; ?>" selected><?php echo $page->cc_type; ?></option>
