...
$user_name = $this->enduser_model->getUserNameById($user_id);
if ($status != 'close')
{
?>
<style>
...
<!-- page content -->
	...
	<?php } ?>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-4">
		  <input type="text" readonly  required="required" class="form-control" id="name" name="name" value="<?php echo $user_name;?>" placeholder="Name">
		  ...
		  <div class="form-group">
		  <label class="control-label col-md-3">Expense Cat.:<span class="required">* </span></label>
		  <div class="col-md-4">
		...
		<div class="form-group">
		  <label class="control-label col-md-3"> Expense sub Cat.:<span class="required">* </span></label>
		  <div class="col-md-4">
...
$(document).ready(function(){ 
 ...
 $('#cat_name').on("change",function () {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/enduser/getallExpSubCat");?>',
            type: "POST",
