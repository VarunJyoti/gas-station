...
*/	
	...
	public function drops()
	{
	   ...
	   $data['page5']	=	$page5;
		...
		//print_r($page6);
		//die('error');
	   $data['MainCat']	 =	$this->dropspayouts_model->getallMainExpCat();
	   $data['page6']	=	$this->enduser_model->getSumPayoutCredit();
	   $data['page7']	=	$this->enduser_model->getSumPayoutCash();
	   $data['page8']	=	$this->enduser_model->getSumDropsreceived();
...
/*
#################################### payouts section ends here ############################################
*/	


/*
#################################### credit card entry section starts here ############################################
*/	
	public function ccard()
	{
	   ...
	   $data['ccard']	 =	$this->enduser_model->getallCcard();
	
		$this->layout('enduser/ccard',$data);  
	
		
	}
	
	
	public function saveccard()
	{
		$SITE_TITLE = SITE_TITLE;
		$data['title'] = "$SITE_TITLE Admin || Add Page";
		$this->form_validation->set_rules('email', 'Email', 'trim|required|valid_email|xss_clean');
		...
		//	die("error");
			...
			if($id)
			{
				$page 	=	$this->ccard_model->savePage($id);
				$this->session->set_flashdata('success', '<div class="alert alert-success "><span>Record Updated SuccesFully</span></div> ');			
				
				redirect("admin/enduser/ccard");

			} else {
				$page 	=	$this->ccard_model->savePage(NULL);
				$this->session->set_flashdata('success', '<div class="alert alert-success "><span>Entry Add SuccesFully</span></div> ');			
				redirect("admin/enduser/ccard");
			}			
	...
	public function edit_ccardentry($id) {
		$SITE_TITLE = SITE_TITLE;
		$data['title'] = "$SITE_TITLE Admin || Edit Page";
		$page 			=	$this->ccard_model->getPage($id);
		//$data['enduser'] = $this->enduser_model->getallProduct(); 
		
		if($page) {
			
			$data['page']	=	$page;
			$this->layout('enduser/edit_ccardentry',$data);
	...
	public function deleteccard($id)
	{
		if($id)
		{		
				$result 			=	$this->enduser_model->deleteCcardEntry($id);
	...
	/*
#################################### credit card entry section ends here ############################################
*/

/*
#################################### credit amount entry section starts here ############################################
*/

 public function creditamount_entry()
	{
		$SITE_TITLE = SITE_TITLE;
		$data['title'] = "$SITE_TITLE Admin || Add Page";
		$data['error'] = "";
	   
	    $data['CreditAmountEntry']	 =	$this->dropspayouts_model->getallCreditAmountEntry();
	    $data['customer']	 =	$this->company_model->getallCreditCustomers();
	   // print_r($data['customer']); die('ere');
		$this->layout('enduser/creditamount_entry',$data);  
	 }
	 
	public function SaveCreditAmount()
	{
		$SITE_TITLE = SITE_TITLE;
		$data['title'] = "$SITE_TITLE Admin || Add Page";
		$this->form_validation->set_rules('email', 'Email', 'trim|required|valid_email|xss_clean');
		...
		//	die("error");
			...
			if($id)
			{
				$page 	=	$this->dropspayouts_model->SaveCreditAmount($id);
				$this->session->set_flashdata('success', '<div class="alert alert-success "><span>Record Updated SuccesFully</span></div> ');			
				
				redirect("admin/enduser/creditamount_entry");

			} else {
				$page 	=	$this->dropspayouts_model->SaveCreditAmount(NULL);
				$this->session->set_flashdata('success', '<div class="alert alert-success "><span>Entry Add SuccesFully</span></div> ');			
				redirect("admin/enduser/creditamount_entry");
			}			
	...
	public function edit_creditentry($id) {
		$SITE_TITLE = SITE_TITLE;
		$data['title'] = "$SITE_TITLE Admin || Edit Page";
		$page 			=	$this->dropspayouts_model->getPages($id);
		//$data['enduser'] = $this->enduser_model->getallProduct(); 
		
		if($page) {
			
			$data['page']	=	$page;
			$this->layout('enduser/edit_creditentry',$data);
 ...
 /*
#################################### credit amount entry section ends here ############################################
*/


/*
#################################### gasoline received  entry section starts here ############################################
*/
...
/*
#################################### gasoline received entry section ends here ############################################
*/
	
	
	
/*
#################################### store sales section starts here ############################################
*/	
...
*/	
	...
	*/
	...
	public function DeleteCreditEntry($id)  
	{
		if($id)
		{		
          $result 			=	$this->enduser_model->deleteCreditEntry($id);
				$this->session->set_flashdata('success', '<div class="alert alert-success "><span>Record Deleted SuccesFully</span></div> ');$this->load->library('user_agent');
				redirect($this->agent->referrer());
		}
