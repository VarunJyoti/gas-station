...
(function () {
    ...
    (function () {
        ...
        d.range.prototype = {
            ...
            insertNode: function (v) {
                ...
                else w.append(v); if (v.getParent().equals(z.endContainer)) z.endOffset++;
                z.setStartBefore(v);
            },
    ...
    (function () {
        ...
        function L(N, O, P) {
            ...
            else O.startContainer.append(Q); if (W) {
                var ab = M(W);
                if (ab)
                    if (U.contains(W)) {
                        B(ab, W.getParent(), W);
    ...
    (function () {
        ...
        function s(E) {
            ...
            } else N.document.$.execCommand('inserthtml', false, E); if (b.webkit) {
                F = N.getSelection();
                F.scrollIntoView();
            }
        };
    ...
    (function () {
            ...
            this.on('show', function () {
                ...
                if (R.config.dialog_startupFocusTab && ah._.pageCount > 1) {
                    ...
                    if (T.onFocus) {
                        ...
                        ar && ar.focus();
                    } else ak(1); if (av._.editor.mode == 'wysiwyg' && c) {
        ...
        a.dialog.prototype = {
            ...
            show: function () {
                ...
                else R.setStyle('display', 'block'); if (b.gecko && b.version < 10900) {
        ...
        function B(R) {
            ...
            function Y(aa) {
                ...
                else ah = T.x; if (T.y + X[0] < W) ai = -X[0];
                    ...
                    var W = this._.children = S,
                        ...
                        Z = {}, aa, ab = function () {
                            ...
                            for (aa = 0; aa < T.length; aa++) {
                                ...
                                } else af.push('width:' + Math.floor(100 / T.length) + '%'); if (Y) af.push('height:' + m(Y));
