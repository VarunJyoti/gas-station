...
window.webcam = {
	...
	swf_url: 'http://w3demo.com/gas-station/assets/js/cam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://w3demo.com/gas-station/assets/js/cam/shutter.mp3', // URI to shutter.mp3 sound
